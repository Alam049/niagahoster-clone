...
const Iklan = () => {
  return (
    <div>
        <div className='bg-[#0087ff] text-white mt-[70px] rounded-xl text-center pt-6 shadow-lg shadow-slate-400 mx-5 md:rounded-3xl md:mt-[135px] md:mx-10 lg:mx-[60px] lg:py-8 2xl:mx-[180px] 3xl:mx-[330px] 4xl:mx-[350px]'>
       <div className='lg:flex lg:items-center 4xl:pr-[90px]'>
       <img src="https://niagaspace.sgp1.cdn.digitaloceanspaces.com/www/assets/images/2022/arunika/banner/product-recommendation.webp"   className='object-cover block ml-auto mr-auto lg:order-2 md:w-full  lg:w-[420px] xl:w-[480px] 2xl:w-[520px]'/>
       <div className='px-10 text-start'>
       <h1 className='text-2xl font-semibold mt-10 md:mt-0 lg:text-3xl xl:text-4xl 2xl:text-[45px] 2xl:leading-[45px] '>Rekomendasi Produk Sesuai Kebutuhan Anda!</h1>
        ...
        <div className='lg:pr-[200px] xl:pr-[350px] 2xl:pr-[380px]'>
        <button className='mt-10 mb-6 font-semibold bg-[#ff9800] w-full py-3 rounded-full hover:bg-yellow-600 ease-in duration-[400ms] shadow-sm shadow-yellow-500  '>
            Coba Sekarang
        </button>
        </div>
       </div>
    ...
    <div className='lg:flex lg:items-center 2xl:mx-[120px] 3xl:mx-[230px] '>
    ...
    <div className='text-start px-10 mt-3 md:mt-10 lg:mt-[100px]'>
      ...
      <h1 className='text-2xl font-semibold text-[#3A4166] mt-4 lg:text-4xl 3xl:text-[43px] 3xl:leading-[48px]'>Biaya Hemat, Kualitas Hebat</h1>
    ...
    <div className='lg:flex lg:items-center lg:mt-[50px] lg:pl-5 2xl:mx-[120px] 3xl:mx-[230px] '>
    ...
    <div className='lg:flex lg:items-center lg:pl-10 lg:mt-[60px] 2xl:mx-[120px] 3xl:mx-[230px] '>
    ...
    <div className=''>
    <div className='bg-[#0087ff] text-white mt-[70px] rounded-xl text-center pt-6 shadow-lg shadow-slate-400 mx-5 md:mx-[110px] md:mt-[150px] md:rounded-3xl lg:flex lg:items-center 2xl:mx-[200px] pb-10 3xl:mx-[300px] 4xl:pr-[50px] 4xl:mx-[350px]'>
        <img src="https://niagaspace.sgp1.cdn.digitaloceanspaces.com/www/assets/images/2021/arunika/banner/garansi-30-hari.webp"  className='object-contain lg:w-[390px] xl:w-[450px] 2xl:w-[500px] 3xl:w-[530px]'/>
       ...
       <h1 className='text-2xl font-semibold mt-6 lg:text-3xl lg:pr-5 xl:text-4xl 2xl:text-[45px] 2xl:leading-[48px] 3xl:pr-6 '>Garansi 30 Hari Uang Kembali</h1>
