    ...
    <div>
        <div className='md:grid md:grid-cols-2 mt-[60px] md:justify-items-center  md:gap-2 md:px-[85px] lg:grid-cols-3 lg:gap-8 lg:px-[60px]'>
                ...
                <div className=" mx-8 md:mx-0 mt-10 border mr-[110px] shadow-2xl rounded-2xl overflow-hidden h-[615px]  md:mr-1 md:h-[555px] lg:h-[510px] ">
                    ...
                    <div className='flex items-center gap-3 ml-8 bg-[#FFE082] mr-[192px] px-3 mt-10 rounded-[4px] py-2 md:mt-8 lg:mr-0'>
                ...
                {/* card2 */}
                <div className=" mx-10 mt-10 border mr-[110px] md:mx-0 shadow-2xl rounded-2xl md:mr-1 overflow-hidden h-[555px] md:h-[555px] lg:h-[510px] ">
                    ...
                    <div className='lg:flex lg:items-center lg:gap-2' >
                    <div className='flex items-center gap-3 ml-8 bg-[#FFE082] mr-[185px] px-3 mt-8 rounded-[4px] py-2 lg:mr-0'>
                    <img src="https://niagaspace.sgp1.cdn.digitaloceanspaces.com/assets/images/2022/arunika/icon-signal-2-bar-1654245883.webp"className="object-cover w-3"  />
                        <p className='text-[#C77700] text-xs font-medium'>Intermediate</p>
                    </div>
                ...
                {/* card3 */}
                <div className=" mx-10 md:mx-0 mt-10 border mr-[110px] shadow-2xl rounded-2xl overflow-hidden h-[545px] md:mr-1 lg:h-[510px] ">
                    ...
                    <div className='flex items-center gap-3 ml-8 bg-[#ADEBE3] mr-[166px] px-3 mt-2 rounded-[4px] py-2 md:mr-[185px] lg:mr-0 lg:ml-0 lg:mt-8 '>
                ...
                {/* card4 */}
                <div className=" mx-10 md:mx-0 mt-10 border mr-[110px] shadow-2xl rounded-2xl overflow-hidden h-[535px] md:mr-1 lg:h-[490px] ">
                ...
                {/* card5 */}
                <div className=" mx-10  mt-10 border mr-[110px] shadow-2xl rounded-2xl overflow-hidden h-[545px] md:mr-[0.1px] md:mx-0 lg:h-[490px] ">
                    ...
                    <div className='lg:flex lg:items-center lg:gap-2'>
                    <div className='flex items-center gap-3 ml-8 bg-[#ADEBE3] mr-[205px] px-3 mt-6 rounded-[4px] py-2 md:mr-[230px] lg:mr-0 '>
                ...
                <div className=" mx-10 mt-10 border mr-[110px] shadow-2xl rounded-2xl overflow-hidden h-[545px] md:mr-[0.1px] md:mx-0 lg:h-[490px] ">
                    ...
                    <div className='flex items-center gap-3 ml-8 bg-[#e0efff] mr-[195px] px-3 mt-2 rounded-[4px] py-2 md:mr-[220px] lg:mr-0 lg:ml-0 lg:mt-6 '>
                ...
                {/* card7 */}
                <div className=" mx-10 mt-10 border mr-[110px] shadow-2xl rounded-2xl overflow-hidden h-[505px] md:mr-[0.1px] md:mx-0 ">
                    ...
                    <div className='flex items-center gap-3 ml-8 bg-[#E0EFFF] mr-[210px] px-3 mt-5 rounded-[4px] py-2 lg:mr-[230px]'>
                    <img src="https://niagaspace.sgp1.cdn.digitaloceanspaces.com/assets/images/2022/arunika/icon-star-1654247009.webp" className="object-cover w-3"  />
                ...
                {/* promo */}
                <div className=" hidden md:hidden lg:block bg-[#0087ff] text-white mx-10 mt-10 border mr-[110px] shadow-2xl rounded-2xl overflow-hidden h-[490px] md:mr-[0.1px] md:mx-0 text-center  ">
