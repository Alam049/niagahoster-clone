...
const Profile = () => {
  return (
    <div className='lg:mr-[60px] sm:ml-5 md:ml-0'>
        ...
        <div className='grid gap-6 mt-5  mr-7 text-white text-sm md:mr-[120px] md:mt-6 lg:mr-0 lg:leading-6 lg:ml-0 md:leading-[28px]'>
