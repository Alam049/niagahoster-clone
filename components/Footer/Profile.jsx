...
const Profile = () => {
  return (
    <div className='lg:mr-[60px]'>
        <div className='flex gap-3 items-center lg:mt-0 lg:ml-0 ml-5 mt-8 '>
        <img src="https://niagaspace.sgp1.cdn.digitaloceanspaces.com/www/assets/images/2021/logo/nh-logo-white.svg" />
        
        </div>
        <div className='grid gap-6 mt-5 ml-5 mr-7 text-white text-sm md:mr-[120px] md:mt-6 lg:mr-0 lg:leading-6 lg:ml-0'>
