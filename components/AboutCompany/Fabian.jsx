   ...
   <div>
     <div className='bg-[#f5faff]'>
        ...
        <div className=''>
            ...
            <img src="https://niagaspace.sgp1.cdn.digitaloceanspaces.com/www/assets/images/2021/arunika/testimony/sate-ratu.webp" className="object-contain  rounded-2xl block mr-auto ml-auto lg:w-[1500px] xl:w-[1200px] "  />
            </div>
            <h1 className='text-center text-xl px-[50px] mt-8 font-semibold md:mt-8 md:px-10 lg:px-[120px] lg:mt-0 xl:mt-5 xl:px-10 text-[#29384E] '>Fabian Budi Seputro - Owner Sate Ratu</h1>
        </div>
        </div>
